...
const AlarmForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      color: color.map((item) => item.value),
      fuelType: fuelType.map((item) => item.value),
      chassisState: chassisState.map((item) => item.value),
      engineState: engineState.map((item) => item.value),
      bodyState: bodyState.map((item) => item.value),
      gearbox: gearbox.map((item) => item.value),
    };
